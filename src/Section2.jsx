...
// const HeroSection = () => {
//   return (
//     <section className="w-[1440px] h-[869px] top-[2620px] bg-[rgba(114,185,68,0.08)]  mx-auto flex flex-col items-center text-center">
//         <div className="w-[1440px] h-[869px] top-[2620px] space-y-4 ">
//             <h1 className="w-[919px] h-[39px] top-[2690px] left-[260px] text-[55px] font-extrabold text-center leading-[62px] tracking-[-1px] text-[#262626] font-redhat">
//                 Discover Homeownership on youself
//             </h1>
//             <br />
...
//           src={house} 
//           alt="Modern House" 
//           className="w-[1280px] h-[448px] rounded-[45px] left-[1280px] scale-x-[-1] object-cover bg-[linear-gradient(0deg,#D9D9D9,#D9D9D9),linear-gradient(260.98deg,#000000_-14.78%,rgba(104,104,104,0)_75.7%),linear-gradient(281.86deg,#000000_-2.26%,rgba(0,0,0,0)_66.31%)]"
//         />
...
//           <div className="w-[547px] h-[215px] top-[93px] left-[93px] gap-[37px] text-white text-left">
//             <h2 className="w-[547px] h-[39px] text-[55px] font-extrabold leading-[62px] tracking-[-1px] font-redhat">
//                 Explore Your Options
//             </h2>
//             <br />
//             <p className="w-[547px] h-[139px] text-[20px] font-normal leading-[25px] tracking-[0px] opacity-75 font-redhat">
...
//             </p>
//             <br />
//             <button className="w-[187px] h-[49px] top-[317px] left-[96px] rounded-full border border-white pt[19px] pr-[32px] pb-[19] pl-[32px] gap-[10px] hover:bg-white ">
//               <span className="w-[123px] h-[11px] text-[16px] font-normal leading-[24px] tracking-[0px] text-center text-white font-redhat  hover:text-black transition">Start Your Search</span>
//             </button>
//           </div>
//         </div>
//       </div>
...
//         {/* Dark Gradient Overlay */}
//         <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent rounded-[45px] flex items-center justify-start pl-10">
...
//               Deciding to become a homeowner is a big deal! Luckily, with Homes.com, you get the most accurate homes for sale property data, an agent directory, and collaboration tools to browse with your agent and co-shopper to help you make the right decision.
//             </p>
//             <button className="mt-6 w-[189px] h-[49px] rounded-full border border-white pt[19px] pr-[32px] pb-[19] pl-[32px] gap-[10px] text-[16px] font-normal leading-[24px] tracking-[0px] text-center text-white font-redhat hover:bg-white hover:text-black transition">
//               Start Your Search
//             </button>
//           </div>
//         </div>
    ...
    <section className="w-[1440px] h-[869px] bg-[rgba(114,185,68,0.08)] mx-auto flex flex-col items-center text-center">
      ...
      <div className="relative w-[1280px] h-[448px] rounded-[45px] mt-8 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/90 to-transparent rounded-[45px] flex items-center justify-start pl-16">
          {/* Overlay Content Positioned to the Left with Extra Padding */}
